...
#    Updated: 2020/11/10 14:50:16 by hdanyel          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS    = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalpha.c ft_isalnum.c ft_isascii.c ft_isdigit.c ft_isprint.c  \
	ft_itoa.c	  ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c ft_memset.c ft_putchar_fd.c ft_putendl_fd.c \
		ft_putnbr.c   ft_putstr_fd.c  ft_split.c ft_strchr.c ft_strdup.c ft_strjoin.c ft_strlcat.c  \
